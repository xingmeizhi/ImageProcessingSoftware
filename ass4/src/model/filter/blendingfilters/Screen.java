...
/**
 * This class represents a Brightening Blending Filter: Screen.
 */
public class Screen extends AbstractFilter {
  private final IImage image1;
  ...
  /**
   * Constructs a new Screen filter with the specified layer, merged image,
   * and offset values.
   *
   ...
   */
  public Screen(ILayer layer, IImage mergedImage, int offsetX, int offsetY) {
    this.image1 = layer.getImage();
