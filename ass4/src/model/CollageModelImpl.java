...
public class CollageModelImpl implements CollageModel {
  ...
  public void save(String filepath) throws IOException {
    ...
    try (FileWriter writer = new FileWriter(fileToSave)) {
      ...
      for (ILayer layer : project.getLayers()) {
        ...
        writer.write(layerImage.getWidth() + " " + layerImage.getHeight() + " " + layer.getX() + " " + layer.getY() + "\n");
  ...
  public static void main(String[] args) throws IOException {
    ...
    collageModel.save("res/testing/testingsave/testing.collage");
    collageModel.saveImage("res/testing/testingsave/testingsave.ppm");
    ...
    collageModel.saveImage("res/testing/testingdifferencefilter/testing.ppm");
    collageModel.setFilter("Layer3", "Screen");
    collageModel.saveImage("res/testing/testingdifferencefilter/testing1.ppm");
    collageModel.load("res/testing/testingsave/testing.collage");
    collageModel.saveImage("res/testing/testingsave/testingload.ppm");
